...
window.onload = function () {
    ...
    cart.addEventListener('click', () => {
        if (cartModalOverlay.style.transform === 'translateX(50%)') {
            cartModalOverlay.style.transform = 'translateX(0)';
        } else {
            cartModalOverlay.style.transform = 'translateX(50%)';
        }
    });
    ...
    const addToCart = document.getElementsByClassName('item-button');
...
window.onload = function () {
    ...
    const handleIcons = (scrollVal) => {
        ...
        arrowIcons[0].parentElement.style.display = scrollVal <= 0 ? 'block' : 'flex';
        arrowIcons[1].parentElement.style.display = maxScrollableWidth - scrollVal <= 1 ? 'block' : 'flex';
    };
