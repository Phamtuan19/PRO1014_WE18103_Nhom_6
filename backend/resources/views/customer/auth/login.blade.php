            ...
            <div class="col-sm-12 col-lg-8">
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="pills-register" role="tabpanel" aria-labelledby="pills-register-tab"
                        tabindex="0">
                        <div class="mb-3 row">
                            <label class="col-sm-4 col-form-label dp-flex">Họ và tên <span
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-4 col-form-label dp-flex">SĐT (Tên đăng nhập) <span
                                    class="ic-rq">(*)</span></label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" />
                            </div>
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-4 col-form-label dp-flex">Địa chỉ Email <span
                                    class="ic-rq">(*)</span></label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" />
                            </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <button type="button" class="btn btn-info btn-register-acc">Đăng ký tài
                                    khoản</button>
                            </div>
                        </div>
                    </div>
