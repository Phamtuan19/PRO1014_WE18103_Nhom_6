                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between">
                                                ...
                                                @if (isset(request()->isDelete))
                                                    <form id="form-modal"
                                                        action="{{ route('admin.customers.replay', $user->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PATCH')
                                                ...
                                                @else
                                                    <a href="{{ route('admin.customers.show', $user->id) }}" class=""
