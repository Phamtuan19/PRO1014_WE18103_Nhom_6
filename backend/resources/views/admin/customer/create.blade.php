            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{-- <div class="box">
                    <button class="btn btn-modal">Show More</button>
                    <div class="overlay"></div>
                    <div class="modal__box">
                        <h3 class="modal__title">Are you sure?</h3>
                        <p class="modal__text">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga et quos
                            eligendi, cumque iusto, tenetur consequatur sit laborum qui est
                            voluptates veniam, assumenda quasi neque!
                        </p>
                        <p class="modal__text">
                        ...
                        <div class="buttons">
                            <button class="btn modal__button modal__button--yes">Yes!</button>
                            <button class="btn modal__button modal__button--no">No</button>
                        </div>
                    </div>
                </div> --}}
                        ...
                        <form class="forms-sample" action="{{ route('admin.customers.store') }}" method="POST">
                            @csrf
