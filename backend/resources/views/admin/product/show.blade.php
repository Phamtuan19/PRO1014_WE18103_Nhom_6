                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-control" name="author">
                                                ...
                                                @foreach ($authors as $author)
                                                    <option value="{{ $author->id }}" {{ $product->author_id == $author->id ? 'selected' : false }}>{{ $author->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        @error('author')
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-control" name="publishing_house">
                                                ...
                                                @foreach ($allPublishingHouse as $publishingHouse)
                                                    <option value="{{ $publishingHouse->id }}" {{ $product->publishing_house_id == $publishingHouse->id ? 'selected' : false }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input class="form-control" placeholder="dd/mm/yyyy" name="publication_date" value="{{ $product->publication_date }}">
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input class="form-control" placeholder="size ..." name="size" value="{{ $product->detail->size }}">
                                        </div>
                                        @error('size')
                                            <span class="text-danger" style="font-size: 16px">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input class="form-control" placeholder="page number ..." name="page_number" value="{{ $product->detail->page_number }}">
                                        </div>
                                        @error('page_number')
                                            <span class="text-danger" style="font-size: 16px">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input class="form-control" placeholder="Trọng lượng ..." name="weight" value="{{ $product->detail->weight }}">
                                        </div>
                                        @error('weight')
                                            <span class="text-danger" style="font-size: 16px">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input class="form-control" placeholder="Giá nhập ..." name="import_price" value="{{ $product->detail->import_price }}">
                                        </div>
                                        @error('import_price')
                                            <span class="text-danger" style="font-size: 16px">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input class="form-control" placeholder="Giá bán ..." name="price" value="{{ $product->detail->price }}">
                                        </div>
                                        @error('price')
                                            <span class="text-danger" style="font-size: 16px">{{ $message }}</span>
                                        @enderror
