        ...
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body" style="padding: 0 0.5rem 2.5rem;">
...
@section('js')
    <script>
        ...
        price.forEach((e, index) => {
            document.querySelectorAll('.price')[index].innerText = formatCurrency(e.dataset.price);
            document.querySelectorAll('.sale')[index].innerText = formatCurrency(e.dataset.sale);
        });
    </script>
@endsection
