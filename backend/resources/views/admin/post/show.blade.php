    ...
    <form action="{{ route('admin.posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row" style="background: #fff; padding: 42px 24px;">
            ...
            <div class="col-6 form-group">
                ...
                <input type="text" class="form-control" id="introduction" name="introduction" placeholder="Tên bài viết"
        ...
        <div class="col-12 form-group">
            ...
            <input type="file" name="image" id="picture__input" value="">
            @error('image')
            <span class="text-danger" style="font-size: 16px">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="col-12 form-group">
            ...
            <textarea class="form-control" id="exampleTextarea1" name="content"
                rows="4">{{ !empty(old('content')) ? old('content') : $post->content }}</textarea>
            @error('content')
            <span class="text-danger" style="font-size: 16px">{{ $message }}</span>
            @enderror
        </div>
