...
<div class="form-group col-5 d-flex" style="margin: 0">
    <label style="width: 20%;">So với</label>
    <div class="">
        <input type="month" class="form-control form-control-sm week"
            value="{{ request()->endMonth ? request()->endMonth : $endMonth }}" name="endMonth" min="2018-03">
        <span style="color: red; font-size: 12px"></span>
    </div>
</div>
...
<div class="row">
    <div class="col-md-4 stretch-card grid-margin">
        <div class="card bg-gradient-danger card-img-holder text-white turnover">

        </div>
    </div>
    <div class="col-md-4 stretch-card grid-margin">
        <div class="card bg-gradient-info card-img-holder text-white totalOrder">

        </div>
    </div>
    <div class="col-md-4 stretch-card grid-margin">
        <div class="card bg-gradient-success card-img-holder text-white totalOrderSuccess">
    ...
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <div style=""><canvas id="acquisitions"></canvas></div>
            </div>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('admin.orders.show', $order->code_order) }}" class=""
