            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.author.create') }}" style="color: #0d6efd; font-weight: 600">Thêm mới tác giả </a>
                    </li>
                </ol>
            </nav>
        </div>
                            ...
                            <tbody>
                                @foreach ($authors as $index => $author)
                                    <tr>
                                        ...
                                        <td> {{ $author->name }} </td>
                                        <td> {{ $author->slug }} </td>
                                        <td> {{ date_format($author->created_at, 'd-m-Y') }} </td>
                                        <td>
                                            <div class="d-flex justify-content-between">

                                                <a href="{{ route('admin.author.show', $author->id) }}" class=""
