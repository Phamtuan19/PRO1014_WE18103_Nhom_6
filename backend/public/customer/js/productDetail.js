...
service.getPageProductDetailImage(code)
    .then(function (response) {
        if (response.status !== 200) {
            throw new Error(response.status);
        }
...
service.getPageProductDetailIntroduce(code)
    .then(function (response) {
        if (response.status !== 200) {
            throw new Error(response.status);
        }
...
service.getPageProductDetailInformation(code)
    .then(function (response) {
        if (response.status !== 200) {
            throw new Error(response.status);
        }
...
service.getPageProductDetailSuggest(code)
    .then(function (response) {
        if (response.status !== 200) {
            throw new Error(response.status);
        }
